...
import sellergoods.service.SpecificationService;
...
public class SpecificationServiceImpl extends BaseServiceImpl<TbSpecification> implements SpecificationService {
    ...
    public PageResult search(Integer page, Integer rows, TbSpecification specification) {
        ...
        List<TbSpecification> list = specificationDao.selectByExample(example);
    ...
    public void add(Specification specification) {
        //新增规格
        specificationDao.insertSelective(specification.getSpecification());
        ...
        if(specification.getSpecificationOptionList() != null &&
            ...
            for(TbSpecificationOption tbSpecificationOption : specification.getSpecificationOptionList()){
                ...
                specificationOptionDao.insertSelective(tbSpecificationOption);
            }
        }
    }
    ...
    public Specification findOne(Long id) {
        ...
        //查询并设置规格
        specification.setSpecification(specificationDao.selectByPrimaryKey(id));

        //查询并设置规格选项列表
        TbSpecificationOption param = new TbSpecificationOption();
        param.setSpecId(id);
        List<TbSpecificationOption> specificationOptionList =
                specificationOptionDao.select(param);
    ...
    public void update(Specification specification) {
        //更新规格
        specificationDao.updateByPrimaryKeySelective(specification.getSpecification());

        //删除原规格选项
        TbSpecificationOption param = new TbSpecificationOption();
        param.setSpecId(specification.getSpecification().getId());
        specificationOptionDao.delete(param);
