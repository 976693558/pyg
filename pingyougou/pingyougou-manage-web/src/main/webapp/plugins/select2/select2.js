...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        opening: function() {
            ...
            this.container.addClass("select2-dropdown-open").addClass("select2-container-activemq");
            ...
            this.dropdown.addClass("select2-drop-activemq");
        ...
        close: function () {
            ...
            this.dropdown.removeAttr("id"); // only the activemq dropdown has the select2-drop id
            this.dropdown.hide();
            this.container.removeClass("select2-dropdown-open").removeClass("select2-container-activemq");
            this.results.empty();


            this.clearSearch();
            this.search.removeClass("select2-activemq");
        ...
        highlight: function (index) {
            ...
            // ensure assistive technology can determine the activemq choice
        ...
        loadMoreIfNeeded: function () {
            ...
            if (below <= this.opts.loadMorePadding) {
                more.addClass("select2-activemq");
                this.opts.query({
        ...
        updateResults: function (initial) {
            ...
            function postRender() {
                search.removeClass("select2-activemq");
                self.positionDropdown();
            ...
            search.addClass("select2-activemq");
        ...
        blur: function () {
            ...
            this.close();
            this.container.removeClass("select2-container-activemq");
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        // single
        isFocused: function () {
            return this.container.hasClass("select2-container-activemq");
        },
        ...
        initContainer: function () {
            ...
            selection.on("mousedown touchstart", this.bind(function (e) {
                ...
                if (!this.container.hasClass("select2-container-activemq")) {
            ...
            this.focusser.on("focus", this.bind(function(){
                ...
                this.container.addClass("select2-container-activemq");
